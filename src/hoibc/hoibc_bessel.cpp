...
complex hoibc::bessel1(const real& nu, const complex& z){
  real yr, yi;
  int nz;
...
complex hoibc::bessel2(const real& nu, const complex& z){
  real yr, yi;
  int nz;
...
complex hoibc::bessel1p(const real& nu, const complex& z){
  return - bessel1(nu+1,z) + nu/z*bessel1(nu,z);
}

complex hoibc::bessel2p(const real& nu, const complex& z){
  return - bessel2(nu+1,z) + nu/z*bessel2(nu,z);
}

complex hoibc::sbessel1(const real& nu, const complex& z){
  return std::sqrt(0.5*pi/z)*bessel1(nu+0.5,z);
}

complex hoibc::sbessel2(const real& nu, const complex& z){
  return std::sqrt(0.5*pi/z)*bessel2(nu+0.5,z);
}

complex hoibc::sbessel1p(const real& nu, const complex& z){
  return std::sqrt(0.5*pi/z)*bessel1p(nu+0.5,z) - 0.5*std::sqrt(0.5*pi/std::pow(z,3))*bessel1(nu+0.5,z);
}

complex hoibc::sbessel2p(const real& nu, const complex& z){
